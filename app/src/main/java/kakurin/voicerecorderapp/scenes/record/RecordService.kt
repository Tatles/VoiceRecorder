package kakurin.voicerecorderapp.scenes.record
...
class RecordService : Service() {
    ...
    private var mElapsedMillis: Long = 0   //  private var mIncrementTimerTask: TimerTask? = null
    ...
    private fun createNotification(): Notification? {
            ...
            ).setSmallIcon(R.drawable.ic_mic_black_24dp).setContentTitle(getString(R.string.app_name))
                .setContentText(getString(R.string.notification_recording))
                .setOngoing(true)
            mBuilder . setContentIntent (PendingIntent.getActivities(
                applicationContext,
                0,
    ...
    private fun setFileNameAndPath() {
        ...
        do {
            mFileName =
                (getString(R.string.default_file_name) + "_" + dateTime + count + ".mp4")
    ...
    private fun stopRecording() {
        ...
        try {
            mUiScope.launch { withContext(Dispatchers.IO) { mDatabase?.insert(recordingItem) } }
        } catch (e: Exception) {
