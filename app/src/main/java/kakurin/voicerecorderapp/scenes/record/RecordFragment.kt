...
import kakurin.voicerecorderapp.databinding.FragmentRecordBinding
...
class RecordFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        if (!mainActivity.isServiceRunning(RecordService::class.java)) {
            viewModel.resetTimer()
        } else {
            binding.playButton.setImageResource(R.drawable.ic_mic_off_black_24dp)
        }
    ...
    private fun onRecord(start: Boolean) {
        ...
        if (start) {
            playButton.setImageResource(R.drawable.ic_mic_off_black_24dp)
            ...
            playButton.setImageResource(R.drawable.ic_mic_black_24dp)
